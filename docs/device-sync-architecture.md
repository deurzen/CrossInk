...
- Per-book `stats_v5.bin`, EPUB `progress.bin`, bookmark stores, and clipping stores use the new primitives; reader settings, JSON stores, journals, and Device Sync transport remain pending.
