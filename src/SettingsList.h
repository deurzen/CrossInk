...
inline std::vector<SettingInfo> getSettingsList(const SdCardFontRegistry* registry = nullptr) {
  static const std::vector<SettingInfo> baseList = [] {
    ...
    add(SettingInfo::Toggle(StrId::STR_WORD_INBOX_SCREENSHOTS, &CrossPointSettings::wordInboxScreenshots,
                            "wordInboxScreenshots", StrId::STR_CAT_READER));
    ...
    add(SettingInfo::Enum(StrId::STR_SHORT_PWR_BTN, &CrossPointSettings::shortPwrBtn,
                          {StrId::STR_IGNORE,
                           ...
                           StrId::STR_SAVE_WORD_INBOX,
                           StrId::STR_DICTIONARY_LOOKUP},
            ...
            .withEnumRawValues({CrossPointSettings::IGNORE,
                                ...
                                CrossPointSettings::SAVE_WORD_INBOX,
                                CrossPointSettings::DICTIONARY_LOOKUP}));
    ...
    add(SettingInfo::Enum(StrId::STR_LONG_PRESS_MENU_ACTION, &CrossPointSettings::longPressMenuAction,
            ...
            .withEnumRawValues({CrossPointSettings::LONG_MENU_OFF,
                                ...
                                CrossPointSettings::LONG_MENU_SAVE_WORD_INBOX,
                                CrossPointSettings::LONG_MENU_DICTIONARY_LOOKUP}));
